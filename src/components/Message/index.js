...
const prefixCls = 'wz-message';
const iconPrefixCls = 'wz-icon';
const prefixKey = 'wz_message_key_';
...
function notice (content = '', duration = defaultDuration, type, onClose = function () {}, closable = false) {
    ...
    // if loading
    const loadCls = type === 'loading' ? ' wz-load-loop' : '';
