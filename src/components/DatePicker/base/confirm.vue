<template>
    <div :class="[prefixCls + '-confirm']">
        ...
        <Button type="primary" size="small" @click.native="handleClear">{{ t('i.datepicker.clear') }}</Button>
        <Button type="primary" size="small" @click.native="handleSuccess">{{ t('i.datepicker.ok') }}</Button>
    </div>
</template>
<script>
